...
query_crear = """
mutation {
        crearEstudiante(nombre: "Carlos", apellido: "Miranda", carrera: "Informatica") {
            estudiante {
                id
                nombre
                apellido
...
query_crear = """
mutation {
        crearEstudiante(nombre: "Limbre", apellido: "Hilari", carrera: "Arquitectura") {
            estudiante {
                id
                nombre
                apellido
...
query_actualizar = """
mutation {
    actualizarEstudiante(id: 2, carrera: "Antropología") {
        estudiante {
            id
            nombre
            apellido
